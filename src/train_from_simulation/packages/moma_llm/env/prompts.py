...
RETRIAL_PROMPT_FORMAT_ERROR = "The last action cannot be executed due to logical errors or format errors in your previous response. Remember to strictly follow the response format and use the available functions only."