...
MAX_NEW_TOKENS = _getenv_as_int("TG_MAX_NEW_TOKENS", 512)
...
if __name__ == "__main__":
    ...
    fp_out = '/workspace/khointn/SmallPlan/textgames/outputs/SFT-2e-retrial-fulltrain-Llama-3.2-3B-Instruct-unsloth-bnb-4bit'

    set_all_seed()
    model_name = "/workspace/khointn/SmallPlan/rl_outputs/SFT-2e-retrial-fulltrain-Llama-3.2-3B-Instruct-unsloth-bnb-4bit"
